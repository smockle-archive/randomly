 ...
 */
function getLowerInt (degree /*: number */) /*: number */ {
 ...
 * @throws {RangeError} Argument degree must be greater than or equal to 0
 */
function getUpperInt (degree /*: number */) /*: number */ {
  if (!(degree instanceof Number) && typeof degree !== 'number') {
    throw new TypeError('Degree must be a number')
  }
  if (degree <= 0) {
...
function create (
  ...
  switch (type) {
    ...
    case Number:
      return int(getLowerInt(length), getUpperInt(length))
    case Object:
    /* falls through */
    default:
 ...
 */
function sort /* :: <T: string | number | Object> */(
  array /*: Array<T> */
) /*: Array<T> */ {
